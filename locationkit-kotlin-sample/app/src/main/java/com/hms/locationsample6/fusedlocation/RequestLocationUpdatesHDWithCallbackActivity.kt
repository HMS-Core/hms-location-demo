...
class RequestLocationUpdatesHDWithCallbackActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_indoorHdAndHigh.setOnClickListener(this)
        btn_remove_indoorHdAndHigh.setOnClickListener(this)
        addLogFragment()
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_indoorHdAndHigh -> getLocationWithIndoor()
            R.id.btn_remove_indoorHdAndHigh -> removeLocationIndoor()
        }
    }
